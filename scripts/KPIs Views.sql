...
-- __________________________________________This SP will create 30 VIEWs _____________________________________________________________________________________
-- ____________________________________________________________________________________________________________________________________________________________
...
-- Net Revenue
    DROP VIEW IF EXISTS net_revenue;
    CREATE VIEW net_revenue AS
      SELECT SUM(oi.price_usd) - SUM(oir.refund_amount_usd) AS net_revenue
...
-- Gross Merchandise Value (GMV)
    ...
    CREATE VIEW gmv AS
      SELECT SUM(price_usd) AS volume_of_transactions
      FROM order_items;
